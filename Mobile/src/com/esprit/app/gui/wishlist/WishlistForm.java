    ...
    public WishlistForm(Form previous, Resources res)throws IOException{
        ...
        Container list = new Container(BoxLayout.y());
                ...
                for (Wishlist wishlist : wishlists) {
                    ...
                    Image i = URLImage.createToStorage(placeholder, t.getImage() != null ? Statics.BASE_URL+"/uploads/"+t.getImage() : Statics.BASE_URL+"/uploads/no_image.png", t.getImage() != null ? Statics.BASE_URL+"/uploads/"+t.getImage() : Statics.BASE_URL+"/uploads/no_image.png");
