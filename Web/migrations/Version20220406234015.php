 ...
 */
final class Version20220406234015 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livraison CHANGE id_produit id_produit INT NOT NULL, CHANGE adresse adresse INT NOT NULL, CHANGE iduser iduser INT NOT NULL');
