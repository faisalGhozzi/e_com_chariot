...
return [
    ...
    'uploadJson' => [[], ['_controller' => 'App\\Controller\\Mobile\\ArticleController::uploadImage'], [], [['text', '/article/json/upload']], [], []],
    ...
    'cartJson' => [[], ['_controller' => 'App\\Controller\\Mobile\\CartController::index'], [], [['text', '/cart/json']], [], []],
    'cartJsonAdd' => [[], ['_controller' => 'App\\Controller\\Mobile\\CartController::add'], [], [['text', '/cart/json/add']], [], []],
    'cartJsonRemove' => [[], ['_controller' => 'App\\Controller\\Mobile\\CartController::remove'], [], [['text', '/cart/json/remove/']], [], []],
    'cartJsonDelete' => [[], ['_controller' => 'App\\Controller\\Mobile\\CartController::delete'], [], [['text', '/cart/json/delete']], [], []],
    'cartJsonDeleteAll' => [[], ['_controller' => 'App\\Controller\\Mobile\\CartController::deleteAll'], [], [['text', '/cart/json/delete/all']], [], []],
    ...
    'CommentairesJsonNewAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\CommentaireController::newCommentaireJson'], [], [['text', '/commentaires/json/new']], [], []],
    'CommentairesJsonUpdateAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\CommentaireController::updateCommentaireJson'], [], [['text', '/commentaires/json/update']], [], []],
    'CommentairesIdJson' => [['id'], ['_controller' => 'App\\Controller\\Mobile\\CommentaireController::CommentairesIdJson'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/commentaires/json']], [], []],
    ...
    'LivraisonsSansLivreursJsonAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\LivraisonController::livraisonsSansLivreursJsonAction'], [], [['text', '/livraisons/nolivreur/json']], [], []],
    'LivraisonsJsonNewAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\LivraisonController::newLivraisonJson'], [], [['text', '/livraisons/json/new']], [], []],
    'LivraisonsJsonUpdateAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\LivraisonController::updateLivraisonJson'], [], [['text', '/livraisons/json/update']], [], []],
    ...
    'LivreursJsonNewAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\LivreurController::newLivreurJson'], [], [['text', '/livreurs/json/new']], [], []],
    'LivreursJsonUpdateAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\LivreurController::updateLivreurJson'], [], [['text', '/livreurs/json/update']], [], []],
    ...
    'newProduitJsonAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\ProduitController::newSalleJsonAction'], [], [['text', '/produits/json/new']], [], []],
    'updateProduitJsonAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\ProduitController::updateSalleJsonAction'], [], [['text', '/produits/json/update']], [], []],
    'uploadsProduitsJson' => [[], ['_controller' => 'App\\Controller\\Mobile\\ProduitController::uploadImage'], [], [['text', '/produits/json/upload']], [], []],
    'ProduitsJsonAction' => [['id'], ['_controller' => 'App\\Controller\\Mobile\\ProduitController::produitsJsonAction'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/produits/json/categorie']], [], []],
    ...
    'ReservationsJsonNewAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\ReservationController::newReservationJson'], [], [['text', '/reservations/json/new']], [], []],
    'ReservationsJsonUpdateAction' => [[], ['_controller' => 'App\\Controller\\Mobile\\ReservationController::updateAdresseJson'], [], [['text', '/reservations/json/update']], [], []],
    'ReservationsJsonAction' => [['id'], ['_controller' => 'App\\Controller\\Mobile\\ReservationController::reservationsJsonAction'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservations/json/salle']], [], []],
    'ReservationsUserJsonAction' => [['id'], ['_controller' => 'App\\Controller\\Mobile\\ReservationController::reservationsUserJsonAction'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/reservations/json/user']], [], []],
    ...
    'uploadSallesJson' => [[], ['_controller' => 'App\\Controller\\Mobile\\SalleController::uploadImage'], [], [['text', '/salles/json/upload']], [], []],
