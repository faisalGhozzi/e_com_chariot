...
class Article extends \App\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'idarticle', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'contenu', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'etat', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'nbrreact', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'auteur'];
        }
    ...
    public function getNbrreact(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbrreact', []);

        return parent::getNbrreact();
    }

    /**
     * {@inheritDoc}
     */
    public function setNbrreact(int $nbrreact): \App\Entity\Article
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrreact', [$nbrreact]);

        return parent::setNbrreact($nbrreact);
    }
