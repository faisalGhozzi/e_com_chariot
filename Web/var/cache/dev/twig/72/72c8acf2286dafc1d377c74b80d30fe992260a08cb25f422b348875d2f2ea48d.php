...
class __TwigTemplate_e16681999f9b0c4bc3a1e582a79b49c4d7055c201de001d10efe184d7e7f6162 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["c"]) {
            // line 7
            echo "    <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("articledetail", ["id" => twig_get_attribute($this->env, $this->source, $context["c"], "idcateg", [], "any", false, false, false, 7)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "nomcateg", [], "any", false, false, false, 7), "html", null, true);
            echo "</a>
    ";
        }
    ...
    {
        return array (  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {% for c in categories %}
    <a href=\"{{ path('articledetail', {'id': c.idcateg}) }}\">{{ c.nomcateg }}</a>
    {% endfor %}
{% endblock %}
", "article/index.html.twig", "C:\\Users\\Faycal Ghozzi\\Desktop\\ProjetsMoney\\e_com_chariot\\Web\\templates\\article\\index.html.twig");
    }
}
