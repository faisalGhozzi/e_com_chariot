...
class __TwigTemplate_94ec081a744e7754bc61316e6d6a14746626b65e1742fe463e2d193b18a1d4e5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "
            <div class=\"form-group\">
                ...
                ";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "contenuC", [], "any", false, false, false, 8), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "contenu"]]);
        echo "
                ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "contenuC", [], "any", false, false, false, 9), 'errors', ["attr" => ["class" => "text-danger"]]);
        echo "
            </div>
            ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "Submit", [], "any", false, false, false, 11), 'widget', ["attr" => ["class" => "btn btn-info"]]);
        echo "
...
";
    ...
    {
        return array (  92 => 13,  87 => 11,  82 => 9,  78 => 8,  72 => 5,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% endblock %}", "commentaire/index.html.twig", "C:\\Users\\Faycal Ghozzi\\Desktop\\ProjetsMoney\\e_com_chariot\\Web\\templates\\commentaire\\index.html.twig");
    }
}
