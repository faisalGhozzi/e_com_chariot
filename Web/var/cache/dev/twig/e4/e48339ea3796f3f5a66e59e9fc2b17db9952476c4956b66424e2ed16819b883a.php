...
class __TwigTemplate_a71db16e23df58d22c77d28e04647f26319cadc226696485aeed6a714ad2796c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <tbody id=\"trace-text-";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 20, $this->source); })()), "trace", [], "any", false, false, false, 20))) {
            ...
            // line 22
            echo twig_escape_filter($this->env, $___internal_parse_4_, "html");
            // line 25
            echo "</pre>
                ";
        }
...
", "@Twig/Exception/traces_text.html.twig", "C:\\Users\\Faycal Ghozzi\\Desktop\\ProjetsMoney\\e_com_chariot\\Web\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\traces_text.html.twig");
    }
}
