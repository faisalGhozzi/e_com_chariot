...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.5UwZB9b' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_5UwZB9bService()
    {
        return $this->privates['.service_locator.5UwZB9b'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\CardController::add' => ['privates', '.service_locator.o3htLhs', 'get_ServiceLocator_O3htLhsService', false],
            'App\\Controller\\CardController::delete' => ['privates', '.service_locator.kanAnHs', 'get_ServiceLocator_KanAnHsService', false],
            'App\\Controller\\CardController::deleteAll' => ['privates', '.service_locator.o3htLhs', 'get_ServiceLocator_O3htLhsService', false],
            ...
            'App\\Controller\\Mobile\\AdresseController::adressesJsonAction' => ['privates', '.service_locator.m6nwMRh', 'get_ServiceLocator_M6nwMRhService', false],
            ...
            'App\\Controller\\Mobile\\UserController::updateUserJsonAction' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.5UwZB9b'] ?? $this->get_ServiceLocator_5UwZB9bService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd7779 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer3767d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesd5d50 = [
        
    ];

    public function getConnection()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getConnection', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getMetadataFactory', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getExpressionBuilder', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'beginTransaction', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getCache', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getCache();
    }

    public function transactional($func)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'transactional', array('func' => $func), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'wrapInTransaction', array('func' => $func), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'commit', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->commit();
    }

    public function rollback()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'rollback', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getClassMetadata', array('className' => $className), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'createQuery', array('dql' => $dql), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'createNamedQuery', array('name' => $name), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'createQueryBuilder', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'flush', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'clear', array('entityName' => $entityName), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->clear($entityName);
    }

    public function close()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'close', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->close();
    }

    public function persist($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'persist', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'remove', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'refresh', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'detach', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'merge', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getRepository', array('entityName' => $entityName), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'contains', array('entity' => $entity), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getEventManager', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getConfiguration', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'isOpen', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getUnitOfWork', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getProxyFactory', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'initializeObject', array('obj' => $obj), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'getFilters', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'isFiltersStateClean', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'hasFilters', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return $this->valueHolderd7779->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer3767d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd7779) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd7779 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd7779->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__get', ['name' => $name], $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        if (isset(self::$publicPropertiesd5d50[$name])) {
            return $this->valueHolderd7779->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd7779;
    ...
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;
    ...
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__isset', array('name' => $name), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;
    ...
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__unset', array('name' => $name), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;
    ...
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__clone', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        $this->valueHolderd7779 = clone $this->valueHolderd7779;
    }

    public function __sleep()
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, '__sleep', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        return array('valueHolderd7779');
    }
    ...
    {
        $this->initializer3767d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer3767d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'initializeProxy', array(), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd7779;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd7779;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer3767d && ($this->initializer3767d->__invoke($valueHolderd7779, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer3767d) || 1) && $this->valueHolderd7779 = $valueHolderd7779;

        if ($this->valueHolderd7779 === $returnValue = $this->valueHolderd7779->paginate($target, $page, $limit, $options)) {
            return $this;
        }
